...
NS.Constants = {
    ...
    HOT_CACHE_TTL = 60,
    WARM_CACHE_TTL = 600,
    HOT_CACHE_TTL_MIN = 10,
    HOT_CACHE_TTL_MAX = 600,
    HOT_CACHE_TTL_STEP = 5,
    WARM_CACHE_TTL_MIN = 30,
    WARM_CACHE_TTL_MAX = 3600,
    WARM_CACHE_TTL_STEP = 30,
    INSPECT_COOLDOWN = 1.5,
    INSPECT_TIMEOUT = 2.5,
    RETRY_DELAY = 0.15,
    MAX_RETRIES = 8,
    EARLY_PROBE_DELAY = 0.08,
    EARLY_PROBE_ATTEMPTS = 3,
